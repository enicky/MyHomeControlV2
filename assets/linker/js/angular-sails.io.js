...
angular.module('sails.io', [])
  .factory('sailsSocketFactory', function($rootScope, $http, $timeout, $location, $log) {
    ...
    var optionDefaults = {
      url: $location.path() || 'http://localhost:5000/?__sails_io_sdk_version=0.11.0',
    ...
    return function sailsSocketFactory (options) {
      var sailsSocket = {
        ...
        connect: function(options) {
          ...
          this.ioSocket = io.connect(this.options.url, {'force new connection': true});//this.options.url, { reconnect: false });
